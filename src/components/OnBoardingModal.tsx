...
export function OnboardingModal({ userProfile, onCompleteProfile }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xl overflow-y-auto">
      ...
      {/* Main Modal Card */}
      <div className="relative w-full max-w-lg my-8 bg-slate-950 rounded-[2rem] p-8 sm:p-10 shadow-2xl overflow-hidden">
        ...
        {/* Title Section (Seamless background, preserved "Welcome Onboard" badge) */}
        <div className="relative text-center space-y-3 mb-8">
          
          {/* Welcome Onboard Pill Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-cyan-500/10 border border-cyan-500/30 text-sm font-bold text-cyan-300">
        ...
        <form onSubmit={handleSubmit} className="relative space-y-5">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 bg-slate-900/90 border border-white/10 rounded-xl focus-within:border-cyan-500 transition-colors">
            ...
            <div className="col-span-2">
              ...
              <div className="flex items-center gap-2 bg-slate-900/90 border border-white/10 rounded-xl focus-within:border-cyan-500 transition-colors">
                ...
                <input
                  ...
                  className="w-full bg-transparent py-3 pr-4 text-sm text-white placeholder-slate-600 focus:outline-none truncate"
                />
              </div>
            </div>
